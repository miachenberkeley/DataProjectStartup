...
from nltkx.internals import slice_bounds, raise_unorderable_types
from nltkx.collections import *
from nltkx.compat import (class_types, text_type, string_types, total_ordering,

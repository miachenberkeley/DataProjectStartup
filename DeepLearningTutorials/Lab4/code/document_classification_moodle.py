...
for terms in all_terms:
    graph = terms_to_graph(terms,3)
    all.graphs.append[graph]
...
if clf == "LinearSVC":
    classifier_tfidf = svm.LinearsSVC()
    classifier_degree = svm.LinearsSVC()
    classifier_w_degree = svm.LinearsSVC()
    classifier_closeness = svm.LinearsSVC()
    classifier_w_closeness = svm.LinearsSVC()
...
predictions_w_degree = classifier_w_degree.predict(testing_set_degree)



print "accuracy_tfidf", predictions_tfidf
print "predictions_closeness", predictions_closeness
...
metrics.accuracy_score(truth_array,predictions_tfidf)
metrics.accuracy_score(truth_array,predictions_closeness)
metrics.accuracy_score(truth_array,predictions_w_closeness)
metrics.accuracy_score(truth_array,predictions_w_degree)

...
%%----------------------------------------------------
    ...
    ener        = your_code_goes_here;
    %% compute partition function
    Z           = your_code_goes_here;
    %% compute probability of state i in [1 x 2^{nnodes}] vector P
    P           = your_code_goes_here;
